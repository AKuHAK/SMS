...
__asm__(
 ...
 "qmtc2     $t5, $vf2\n\t"
 "qmtc2     $t6, $vf3\n\t"
 "vmula.xyzw    ACC, $vf2, $vf4\n\t"
 "vmadda.xyzw   ACC, $vf3, $vf5\n\t"
 ...
 "vabs.xyzw     $vf2, $vf1\n\t"
 "vmaxw.xyzw    $vf1, $vf0, $vf0\n\t"
 "vmulay.xyzw   ACC, $vf2, $vf7\n\t"
 "vmsubaz.xyzw  ACC, $vf1, $vf7\n\t"
 "vmaddaz.xyzw  ACC, $vf1, $vf7\n\t"
 "vmsubay.xyzw  ACC, $vf2, $vf7\n\t"
 ...
 "vmula.xyzw    ACC, $vf5, $vf4\n\t"
 "vmulx.xyzw    $vf4, $vf1, $vf9\n\t"
 "vmul.xyzw     $vf5, $vf3, $vf3\n\t"
 "vmadda.xyzw   ACC, $vf6, $vf3\n\t"
 "vmadda.xyzw   ACC, $vf2, $vf3\n\t"
 "vmadday.xyzw  ACC, $vf1, $vf9\n\t"
 "vmadd.xyzw    $vf1, $vf4, $vf5\n\t"
 "vmuli.xyzw    $vf1, $vf1, I\n\t"
 "qmfc2     $v0, $vf1\n\t"
 "qfsrv     $v0, $v0, $v0\n\t"
 "pexew     $v0, $v0\n\t"
 "jr        $ra\n\t"
...
__asm__(
 ...
 "vmula.xyzw    ACC, $vf7, $vf5\n\t"
 "vmsub.xyzw    $vf3, $vf8, $vf6\n\t"
 "vmula.xyzw    ACC, $vf7, $vf6\n\t"
 ...
 "vmove.yw      $vf11, $vf1\n\t"
 "vmove.yw      $vf12, $vf2\n\t"
 "vmula.xyzw    ACC, $vf1, $vf9\n\t"
 "vmadd.xyzw    $vf1, $vf7, $vf12\n\t"
 "vmula.xyzw    ACC, $vf2, $vf9\n\t"
