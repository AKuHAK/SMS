...
__asm__(
 ...
 "lqc2      $vf2, 1024($a0)\n\t"
 "lqc2      $vf3, 2048($a0)\n\t"
 "vadda.xyzw    ACC, $vf1, $vf10\n\t"
 "vmaddaw.xyzw  ACC, $vf2, $vf0\n\t"
 "lqc2      $vf4, 3072($a0)\n\t"
 "lqc2      $vf5, 4096($a0)\n\t"
 "vmaddw.xyzw   $vf6, $vf4, $vf0\n\t"
 "vadda.xyzw    ACC, $vf1, $vf10\n\t"
 "vmaddaw.xyzw  ACC, $vf3, $vf0\n\t"
...
__asm__(
 ...
 "lqc2      $vf23, 224($t1)\n\t"
 "lqc2      $vf24, 240($t1)\n\t"
 "vmulax.xyzw   ACC, $vf9, $vf1\n\t"
 "vmadday.xyzw  ACC, $vf10, $vf1\n\t"
 "vmaddaz.xyzw  ACC, $vf11, $vf1\n\t"
 "vmaddaw.xyzw  ACC, $vf12, $vf1\n\t"
 "vmaddax.xyzw  ACC, $vf13, $vf2\n\t"
 "vmadday.xyzw  ACC, $vf14, $vf2\n\t"
 "vmaddaz.xyzw  ACC, $vf15, $vf2\n\t"
 "vmaddaw.xyzw  ACC, $vf16, $vf2\n\t"
 "vmaddax.xyzw  ACC, $vf17, $vf3\n\t"
 "vmadday.xyzw  ACC, $vf18, $vf3\n\t"
 "vmaddaz.xyzw  ACC, $vf19, $vf3\n\t"
 "vmaddaw.xyzw  ACC, $vf20, $vf3\n\t"
 "vmaddax.xyzw  ACC, $vf21, $vf4\n\t"
 "vmadday.xyzw  ACC, $vf22, $vf4\n\t"
 "vmaddaz.xyzw  ACC, $vf23, $vf4\n\t"
 ...
 "lqc2      $vf24, 480($t1)\n\t"
 "lqc2      $vf25, 496($t1)\n\t"
 "vmulax.xyzw   ACC, $vf10, $vf5\n\t"
 "vmadday.xyzw  ACC, $vf11, $vf5\n\t"
 "vmaddaz.xyzw  ACC, $vf12, $vf5\n\t"
 "vmaddaw.xyzw  ACC, $vf13, $vf5\n\t"
 "lqc2      $vf11, 512($t1)\n\t"
 "lqc2      $vf12, 528($t1)\n\t"
 "vmaddax.xyzw  ACC, $vf14, $vf6\n\t"
 "vmadday.xyzw  ACC, $vf15, $vf6\n\t"
 "vmaddaz.xyzw  ACC, $vf16, $vf6\n\t"
 "vmaddaw.xyzw  ACC, $vf17, $vf6\n\t"
 "vmaddax.xyzw  ACC, $vf18, $vf7\n\t"
 "vmadday.xyzw  ACC, $vf19, $vf7\n\t"
 "vmaddaz.xyzw  ACC, $vf20, $vf7\n\t"
 "vmaddaw.xyzw  ACC, $vf21, $vf7\n\t"
 "vmaddax.xyzw  ACC, $vf22, $vf8\n\t"
 "vmadday.xyzw  ACC, $vf23, $vf8\n\t"
 "vmaddaz.xyzw  ACC, $vf24, $vf8\n\t"
 "vmaddw.xyzw   $vf10, $vf25, $vf8\n\t"
 "vmula.xyzw    ACC, $vf12, $vf9\n\t"
 "vmsub.xyzw    $vf12, $vf12, $vf10\n\t"
 "vmula.xyzw    ACC, $vf11, $vf9\n\t"
 ...
 "vmadda.xyzw   ACC, $vf4, $vf6\n\t"
 "pexew     $v0, $v0\n\t"
 "qfsrv     $v0, $v0, $v0\n\t"
 "qmtc2     $v0, $vf7\n\t"
 "vmsub.xyzw    $vf2, $vf4, $vf7\n\t"
 "vadda.xyzw    ACC, $vf1, $vf3\n\t"
 "vmsuba.xyzw   ACC, $vf5, $vf6\n\t"
